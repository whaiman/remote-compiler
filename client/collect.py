...
def resolve_includes(file_path: Path, base_dir: Path, processed_files: Set[Path]) -> Set[Path]:
    ...
    for match in matches:
        ...
        # Heuristic: if we found a header, try to find the matching source file
